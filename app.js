...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var string1 = a  + ' and ' + b + ' and ' + c + ' sum to ' + sum3 + '.';
    var string2 = 'The product of ' +  a + ' and ' + b + ' and ' + c + ' is ' + multiply3 + '.';
...
the first element is the sum of the numbers in the array, and the second element is a string that 
...
function multiplyArray(multArr) { //eslint-disable-line
    var multiple1 = multiply(testArray[0], testArray[1])[0];
    // console.log(multiple1);
    var multiple2 = multiply(multiple1, testArray[2])[0];
    // var addition1 = sum(addition, testArray[2])[0];
    //  console.log(multiple2);
    var string5 = 'The numbers 2,3,4 have a product of ' + multiple2 + '.';
    return [multiple2, string5];
}
